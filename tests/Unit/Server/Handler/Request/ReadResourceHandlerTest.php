...
class ReadResourceHandlerTest extends TestCase
{
    ...
    /** @var array<ReadResourceExceptionEvent|ReadResourceRequestEvent|ReadResourceResultEvent> */
    ...
    protected function setUp(): void
    {
        ...
        $this->eventDispatcher
            ->method('dispatch')
            ->with($this->callback(function (ReadResourceExceptionEvent|ReadResourceRequestEvent|ReadResourceResultEvent $event) {
