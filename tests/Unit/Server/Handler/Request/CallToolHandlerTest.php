...
class CallToolHandlerTest extends TestCase
{
    ...
    public function testAMissingClientCapabilityIsAnswered32021(): void
    {
        $request = $this->createCallToolRequest('slow_tool', []);
        $toolReference = $this->createToolReference('slow_tool', static fn () => null);
        ...
        $this->assertSame('Needs the thing.', $response->message);
        $this->assertSame($required, $response->data['requiredCapabilities']);
