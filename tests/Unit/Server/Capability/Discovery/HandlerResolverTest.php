...
use Mcp\Server\Capability\Discovery\HandlerResolver;
...
class HandlerResolverTest extends TestCase
{
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Invokable handler class "Mcp\Tests\Unit\Server\Capability\Discovery\NonInvokableClass" must have a public "__invoke" method.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Handler method "Mcp\Tests\Unit\Server\Capability\Discovery\AbstractHandlerClass::abstractMethod" must not be abstract.');
