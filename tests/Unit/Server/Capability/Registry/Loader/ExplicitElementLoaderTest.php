...
namespace Mcp\Tests\Unit\Server\Capability\Registry\Loader;
...
final class ExplicitElementLoaderTest extends TestCase
{
    public function testAddToolRegistersDefinitionAndDispatchesToHandler(): void
    {
        ...
        $registry = $this->buildAndGetRegistry(static fn (Builder $b) => $b->add($tool, $handler));
    ...
    public function testAddResourceRegistersDefinitionAndDispatchesToHandler(): void
    {
        ...
        $registry = $this->buildAndGetRegistry(static fn (Builder $b) => $b->add($resource, $handler));
    ...
    public function testAddResourceTemplateRegistersDefinitionAndDispatchesToHandler(): void
    {
        ...
        $registry = $this->buildAndGetRegistry(static fn (Builder $b) => $b->add($template, $handler));
    ...
    public function testAddPromptRegistersDefinitionAndDispatchesToHandler(): void
    {
        ...
        $registry = $this->buildAndGetRegistry(static fn (Builder $b) => $b->add($prompt, $handler));
    ...
    public function testAddPromptForwardsCompletionProvidersToRegistry(): void
    {
        ...
        $registry = $this->buildAndGetRegistry(static fn (Builder $b) => $b->add(
            $prompt,
            $handler,
            ['name' => $provider],
        ));
