 ...
 *
 * The index carries no version marker: the format is versioned by the extension itself, and
 * clients tolerate unrecognized fields so it can grow additively.
 *
 * @phpstan-import-type SkillDiscoveryEntryData from SkillDiscoveryEntry
 *
 * @phpstan-type SkillDiscoveryIndexData array{skills: SkillDiscoveryEntryData[]}
 *
...
final class SkillDiscoveryIndex implements \JsonSerializable
{
    ...
    /**
     * @return array{skills: SkillDiscoveryEntry[]}
     */
