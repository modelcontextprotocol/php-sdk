...
use Mcp\Capability\Registry\Loader\ArrayRegistryLoader;
use Mcp\Capability\Registry\Loader\DiscoveryRegistryLoader;
...
final class Builder
{
    ...
    public function build(): Server
    {
        ...
        $loaders = [
            new ArrayRegistryLoader($this->tools, $this->resources, $this->resourceTemplates, $this->prompts, $logger),
        ];

        if (null !== $this->discoveryBasePath) {
            $loaders[] = new DiscoveryRegistryLoader($this->discoveryBasePath, $this->discoveryScanDirs, $this->discoveryExcludeDirs, $logger, $this->discoveryCache);
        }
