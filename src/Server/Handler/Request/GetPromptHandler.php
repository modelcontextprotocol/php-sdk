...
final class GetPromptHandler implements RequestHandlerInterface
{
    ...
    public function handle(Request $request, SessionInterface $session): Response|Error
    {
        ...
        $getPromptRequestEvent = new GetPromptRequestEvent($request);
        $this->eventDispatcher?->dispatch($getPromptRequestEvent);
        ...
        try {
            ...
            $getPromptResultEvent = new GetPromptResultEvent($request, $result);
            $this->eventDispatcher?->dispatch($getPromptResultEvent);
            ...
            $getPromptExceptionEvent = new GetPromptExceptionEvent($request, $e);
            $this->eventDispatcher?->dispatch($getPromptExceptionEvent);
