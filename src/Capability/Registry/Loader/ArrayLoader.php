    ...
    public function load(RegistryInterface $registry): void
    {
        ...
        foreach ($this->resourceTemplates as $data) {
            try {
                ...
                $registry->registerResourceTemplate($template, $data['handler'], $prepared['completionProviders']);
        ...
        foreach ($this->prompts as $data) {
            try {
                ...
                $registry->registerPrompt($prompt, $data['handler'], $prepared['completionProviders']);
